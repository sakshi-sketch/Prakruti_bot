...
const ShareButton = ({ dosha }) => {
  const handleOnClick = async () => {
    try {
      await window.navigator.share({
        text: `*My Prakruti is ${dosha}*\n\nWhat's yours? You can also discover your Prakruti.\n\nCheck now! 👉 ${window.location.href}\n\nEver wondered about your Prakruti? I found out I'm ${dosha}! Head over to Prakruti Chatbot to reveal yours! 🔍`,
      });
    } catch (e) {
      alert(
  ...
  return (
    <div className="space-y-1">
      <span>Share Your Prakruti with Others : </span>
      <button
        type="button"
